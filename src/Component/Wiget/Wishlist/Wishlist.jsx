...
const Wishlist = ({ activepanel, closepanel, wishlist, addtocart, removefromwishlist, clearwishlist }) => {
  return (
    <div className={`flex flex-col bg-[#071f15] top-0 right-0 bottom-0 left-auto z-[100] w-[400px] fixed h-[100vh] transform transition-transform duration-500 ease-in-out border-l border-white/10
    ...
    >
      ...
      <div className='px-6 py-5 border-b border-white/8 flex-shrink-0 bg-[#0a2e1f]'>
        <div className='flex items-center justify-center gap-2.5'>
          <div className='w-8 h-8 rounded-xl bg-gradient-to-br from-rose-500 to-rose-600 flex items-center justify-center shadow-[0_4px_12px_rgba(244,63,94,0.35)]'>
            <GoHeartFill className='text-white text-sm' />
          </div>
        ...
        {wishlist.length === 0 ? (
          <div className='flex flex-col items-center justify-center h-full gap-3'>
            <div className='w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center'>
              <GoHeartFill className='text-white/20 text-2xl' />
            </div>
            <p className='text-white/30 text-sm font-semibold tracking-wide'>Your wishlist is empty</p>
          </div>
        ) : (
          wishlist.map((product, index) => (
            <div key={index} className='bg-white/5 border border-white/8 rounded-2xl p-3 flex items-center gap-3 hover:bg-white/8 hover:border-rose-500/20 transition-all duration-200'>
              ...
              <div className='flex-1 min-w-0'>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <button
                    className='bg-gradient-to-r from-[#d4a843] to-[#b8892e] text-[#0a2e1f] text-[11px] px-3 py-1.5 rounded-lg font-black tracking-widest uppercase shadow-[0_2px_8px_rgba(212,168,67,0.3)] hover:from-[#e0b550] hover:to-[#c49535] hover:shadow-[0_2px_12px_rgba(212,168,67,0.5)] active:scale-95 transition-all duration-200 cursor-pointer'
        ...
        <button
          ...
          className={`flex-1 h-11 rounded-xl text-[12px] font-black tracking-widest uppercase transition-all duration-200
            ${wishlist.length === 0
              ...
              : 'bg-gradient-to-r from-rose-500 to-rose-600 text-white cursor-pointer hover:from-rose-400 hover:to-rose-500 shadow-[0_4px_16px_rgba(244,63,94,0.3)] hover:shadow-[0_4px_24px_rgba(244,63,94,0.5)] active:scale-[0.98]'
            }`}
        >
          Clear All
        </button>
